...
export INC = -I"/mnt/c/Users/abell/Documents/GitHub/NRE-Math/src" 
...
BIN = bin/
SRC = src
OBJ = $(OBJDIR)NRE_Main.o $(OBJDIR)OS/Linux/NRE_LinuxSystem.o $(OBJDIR)OS/Linux/Event/NRE_LinuxEventSystem.o $(OBJDIR)OS/Linux/Event/Input/NRE_LinuxInputManager.o $(OBJDIR)OS/Linux/Event/Input/Keys/NRE_LinuxKeyTranslater.o $(OBJDIR)OS/Linux/Graphics/Driver/NRE_LinuxGraphicsDriver.o $(OBJDIR)OS/Linux/Graphics/Window/Internal/NRE_LinuxInternalWindow.o $(OBJDIR)OS/Linux/Graphics/Window/Style/NRE_LinuxWindowStyle.o $(OBJDIR)System/NRE_System.o $(OBJDIR)System/CpuID/NRE_CpuID.o $(OBJDIR)System/Graphics/NRE_GraphicsSystem.o $(OBJDIR)System/Graphics/Driver/NRE_GraphicsDriver.o $(OBJDIR)System/Graphics/Window/NRE_Window.o $(OBJDIR)System/Graphics/Window/Attributes/NRE_WindowAttributes.o $(OBJDIR)System/Graphics/Window/Style/NRE_WindowStyle.o $(OBJDIR)System/Info/NRE_SystemInfo.o 
